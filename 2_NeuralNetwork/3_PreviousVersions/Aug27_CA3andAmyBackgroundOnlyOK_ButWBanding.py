...
def build_network(modinput): # (input_noiserate, weight_noiseinput):
    ...
    c_ca3_2amye=[0.25,  2.3*c_fudgeweights]
    ...
    # c_ca3_2ca1i= [0.1825,  0.4*c_fudgeweights]  # CA3 --> CA1 interneurons
    # # Weights from here are arbitrary !!! 
    # c_ca3_2amye=[0.4,  3.3*c_fudgeweights]
    # c_amye_2ca1e=[0.8,  1.5*c_fudgeweights]
    ...
    nest.DivergentConnect(input_noise, pope_amy, weight_noiseinput*0.8, dt)  
    nest.DivergentConnect(input_noise, pope_ca1, weight_noiseinput, dt)  
