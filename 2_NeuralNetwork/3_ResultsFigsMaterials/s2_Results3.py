...
def build_network(modinput): # (input_noiserate, weight_noiseinput):
    ...
    # # Dynamics
    active_spiketimes=np.arange(100.,400.,5.)   # Active input
...
""" [3] Stats on firing rates """
mo['ca3e_raster'], autocor_spiketrain=spiketimes2raster(mo, 'ca3e')
np.savetxt('test.txt', mo['ca3e_raster'])
mo['ca1e_raster'], autocor_spiketrain=spiketimes2raster(mo, 'ca1e')
mo['amy_raster'], autocor_spiketrain=spiketimes2raster(mo, 'amy')
