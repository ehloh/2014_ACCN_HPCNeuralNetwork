...
def build_network(modinput): # (input_rate, weight_input2ca3):
    ...
    input_rate=19800.    # input rate & weight = 19800 & 9 balances CA3 at a higher rate
    weight_input2ca3=9.
    # input_rate=20500.      # input rate & weight= 20500 & 8.25 will get CA3 down to <10 Hz, but excit and inhib is oscillating
    ...
    # input_rate=18900.    # FAKE TEST IF GRID IS OK
...
def scan_weights():
    ...
    for s0 in range(len(scanpar[0])):
        for s1 in range(len(scanpar[1])):
            ...
            print 'Run # ', k
            modinput={'input_rate':  input_rates[s0], 'weight_input2ca3': input_weights[s1]}
